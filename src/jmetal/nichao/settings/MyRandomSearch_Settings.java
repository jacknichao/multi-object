 ...
 */
public class MyRandomSearch_Settings extends BaseSettingsImpl {
   ...
   * @param problemName
   */
  public MyRandomSearch_Settings(String problemName) {
    super(problemName, "jmetal.metaheuristics.randomSearch.RandomSearch");
  }
