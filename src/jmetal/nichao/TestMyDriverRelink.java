 ...
 */
public class TestMyDriverRelink extends Experiment {
...
//        algorithm[4] = new MyRandomSearch_Settings(problemName).configure(parameters[4]);
      ...
      algorithm[0] = new  MySMSEMOA_Settings(problemName).configure(parameters[0]);
//        algorithm[1] = new MyMOCHC_Settings(problemName).configure(parameters[1]);
...
//            algorithm[0] = new MyCellDE_Settings(problemName).configure(parameters[0]);
      ...
      Logger.getLogger(TestMyDriverRelink.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    TestMyDriverRelink exp = new TestMyDriverRelink();

    //名称中避免使用下划线_，因为改名称会被用于生成latex表格
    exp.experimentName_ = "Test2NewMethod";
